                ...
                #前进
                    ...
                    if (sec == 0):
                        ...
                        if(x != 0 and y == 0 and y+h != 119):#左转
                            err_x = 13
                            err_y = int(x - 80)+10
                        if(x != 0 and y == 0 and y+h == 119 and x+w != 159):#第二段直线
                            err_x = 4
                            err_y = int(x - 80)
                        if(x != 0 and y != 0 and y+h == 119 and x + w == 159):#右转
                            err_x = -5
                            err_y = 25
                            if(stopcnt<10):stopcnt = stopcnt + 1
                            else:sec = 1
                        ...
                        if(x != 0 and y != 0 and y+h == 119 and x + w == 159):#右转
                            err_x = int(60 - y)
                            err_y = 25
                        if(x == 0 and y != 0 and y+h != 119 and x+w == 159):#第三段直线
                            err_x = int(60 - y - h / 2)
                            err_y = 13
                        if(x == 0 and y != 0 and y+h != 119 and x+w != 159):#终点悬停
                            err_x = int(60 - y - h/2)
                            err_y = int(x + w - 80 - h/2)
